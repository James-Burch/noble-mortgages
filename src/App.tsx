...
// Simple fallback for non-visual lazy components
const MinimalLoader = () => (
    ...
    <>
      ...
      <main style={{ backgroundColor: "#f8f9fa" }}>
        ...
        <div style={{ backgroundColor: "#f8f9fa" }}>
          <Suspense fallback={<CardGridSkeleton count={5} light />}>
            <ProductCards
        ...
        <div style={{ backgroundColor: "white" }}>
          <Suspense fallback={<CalculatorTeaserSkeleton />}>
            <CalculatorTeaser />
          </Suspense>
        </div>
